    ...
    render()
    {
        ...
        return(
            <div className="app_header">
                            <button className="headerE" onClick={this.handleHome}>e!</button>
                            {isLogged ?  <div>
                                {/* <img src ={image} /> */}
                            ...
                            <Modal
                                ...
                                > 
                                    <div>
                                        ...
                                        <div><span className="glyphicon glyphicon-remove" onClick={this.handleClose} style={{float:'right',margin:'2px'}}></span></div>
                                            <div>
                                              <span style={{fontSize:'15px',fontSize: '20px',textAlign: 'center',top: '10%',position: 'absolute',left: '22%'}}>Login using Social Accounts </span>
                                                ...
                                                <div id="login-account">
                                                    ...
                                                    <div>
                                                      ...
                                                      <input type="button" value="Create an account" className="below_button"  onClick={this.handleCreate}/></span>
                                                      </div>
                                                    </div>
                                            </div>
          ...
          >
            <div>
              ...
              <label className="lblSign">First Name</label>

              <div>
                <input className="inputsFirst"
                  type="type"
                ...
                <label className="lblSign">Last Name</label>
              <div>
                <input className="inputsSecond"
                  type="type"
              ...
              <label className="lblSign">Mobile Number</label>

              <div>
                <input className="inputsThird"
                  type="type"
              ...
              <label className="lblSign">Email</label>
              <div>
                <input className="inputsFourth"
                  type="type"
                  placeholder="Email"
                  onChange={(event) => {
              ...
              <label className="lblSign">Password</label>
              <div>
                <input className="inputsFifth"
                  type="password"
              ...
              <label className="lblSign">Confirm Password</label>

              <div>
                <input className="inputsSix"
                  type="type"
                  placeholder="password"
                  onChange={(event) => {
          ...
          <div>
            <div>
              <div>
                ...
                <div>
                  <button id="signUp-login" className="loginButton" onClick={this.handleloginvalid}>
                    Login
                  </button>
