...
var { getRestaurants, getRestaurantByName, getRestaurantById, addRestaurant, updateRestaurant, deleteRestaurantByName } = require('../controller/restaurantController');
...
// router.put('/updateRestaurant/:name', function (req, res, next) {
